...
from keras.layers import LSTM, SimpleRNN, Dropout, GRU, CuDNNGRU
...
model = Sequential()
#model.add(GRU(32, input_shape=(config.look_back,1)))
model.add(CuDNNGRU(32, input_shape=(config.look_back,1)))
